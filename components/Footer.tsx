...
import { ChevronUp, Phone, MapPin, MessageCircle, Mail } from "lucide-react";
...
export function Footer() {
  ...
  return (
    <footer className="w-full bg-[#596020] text-white text-xs pt-12">
        ...
        <div className="py-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            ...
            <div className="text-[11px] text-stone-300 space-y-1 border-l border-stone-700/60 pl-4">
              ...
              <div className="pt-2 space-y-1">
                ...
                <p className="flex items-center gap-1.5 text-stone-300">
                  <Mail className="w-3.5 h-3.5 text-[#E27412]" />
                  {contato.email}
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col md:items-end space-y-3">
            <span className="text-xs font-semibold text-white tracking-wide">
              Fale Conosco e Siga a Arboville
            </span>
            <div className="flex items-center gap-2">
              <a
                href={contato.whatsappFormatado ? `https://wa.me/${contato.whatsapp}` : "#"}
                target="_blank"
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="w-8 h-8 bg-[#445922] hover:bg-[#354619] text-white rounded flex items-center justify-center transition-colors shadow-sm"
              >
      ...
      <div className="bg-[#12190E] py-4 border-t border-stone-800/60 relative">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-1.5 text-center sm:text-right">
            ...
            <span>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#E27412] hover:text-[#F08A2B] font-semibold transition-colors"
              >
                Webstudio
              </a>
            </span>
        ...
        <button
          ...
          className="absolute right-4 bottom-4 w-9 h-9 bg-[#E27412] hover:bg-[#C86109] text-white rounded-t flex items-center justify-center transition-colors shadow-lg"
        >
